...
CREATE TABLE `__new_files` (
	...
	`bucket_name` text DEFAULT 'test' NOT NULL,
	`user_id` text NOT NULL,
	`created_at` integer NOT NULL,
	`updated_at` integer NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_files`("id", "name", "content_type", "type", "size", "path", "visibility", "preview", "dimensions", "count", "parent_id", "bucket_name", "user_id", "created_at", "updated_at") SELECT "id", "name", "content_type", "type", "size", "path", "visibility", "preview", "dimensions", "count", "parent_id", "bucket_name", "user_id", "created_at", "updated_at" FROM `files`;--> statement-breakpoint
